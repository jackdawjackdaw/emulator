...
void estimate_thetas_BFGS(gsl_matrix* xmodel_input, gsl_vector* training_vector, gsl_vector* thetas, optstruct* options);
...
void estimate_thetas_BFGS(gsl_matrix* xmodel_input, gsl_vector* training_vector, gsl_vector* thetas, optstruct* options){
	...
	maxWithBFGS(random_number,max_tries, number_steps, grad_ranges, xmodel_input, training_vector, thetas,\
							options->nmodel_points, options->nthetas, options->nparams);
